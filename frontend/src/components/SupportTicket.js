...
import { PlusIcon, ChatBubbleLeftRightIcon, CheckCircleIcon, ClockIcon, MapPinIcon, ExclamationTriangleIcon } from '@heroicons/react/24/outline';
...
const SupportTicket = () => {
  ...
  const handleEmergencyClick = () => {
    setFormData({
      ...
      message: 'URGENT: Need immediate roadside assistance. Please contact me as soon as possible.',
      priority: 'urgent',
      location: null
    });
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-gray-600 mt-1">Get help with your orders and emergencies</p>
        </div>
      ...
      <div className="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
        <div className="flex items-center">
          ...
          <div>
            <h3 className="font-semibold text-red-800">Emergency Support Available 24/7</h3>
            <p className="text-sm text-red-700">For roadside assistance or urgent issues, click the Emergency Support button above.</p>
          </div>
        </div>
      </div>
      ...
      {tickets.length === 0 ? (
        <div className="bg-white rounded-lg shadow-md p-12 text-center">
          ...
          <p className="text-gray-500 mb-4">Have a question or emergency? Create a support ticket.</p>
        ...
        <div className="space-y-4">
          {tickets.map((ticket) => (
            <div key={ticket.id} className={`bg-white rounded-lg shadow-md overflow-hidden ${ticket.priority === 'urgent' ? 'border-l-4 border-red-500' : ''}`}>
              <div className="p-4 border-b bg-gray-50">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex space-x-2">
                    <span className={`px-2 py-1 rounded text-xs font-semibold flex items-center ${getPriorityColor(ticket.priority)}`}>
                      {getPriorityIcon(ticket.priority)}
                      {ticket.priority}
                    </span>
          ...
          <div className="relative top-20 mx-auto p-5 border w-full max-w-2xl shadow-lg rounded-md bg-white">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-lg font-bold">
                {showEmergencyForm ? 'Emergency Support Request' : 'Create Support Ticket'}
              </h3>
            ...
            <form onSubmit={handleSubmit}>
              <div className="mb-4">
                ...
                <input
                  ...
                  required
                  className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 ${showEmergencyForm ? 'bg-red-50' : ''}`}
              ...
              <div className="mb-4">
                ...
                <select
                  ...
                  className={`w-full border rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500 ${showEmergencyForm ? 'bg-red-50 font-semibold text-red-800' : ''}`}
              ...
              {/* Location Picker for Emergency or High Priority */}
              {(formData.priority === 'urgent' || formData.priority === 'high' || showEmergencyForm) && (
                <div className="mb-4">
                  <label className="block text-gray-700 mb-1">
                    <MapPinIcon className="h-4 w-4 inline mr-1" />
                    Your Location (Required for emergency)
                  </label>
                  <LocationPicker 
                  ...
                  <p className="text-xs text-gray-500 mt-1">
                    Sharing your location helps us respond faster to emergencies
                  </p>
                </div>
              )}
              ...
              <div className="flex justify-end space-x-3">
                ...
                <button 
                  type="submit" 
                  className={`px-4 py-2 rounded ${showEmergencyForm ? 'bg-red-600 hover:bg-red-700' : 'bg-blue-600 hover:bg-blue-700'} text-white`}
                >
